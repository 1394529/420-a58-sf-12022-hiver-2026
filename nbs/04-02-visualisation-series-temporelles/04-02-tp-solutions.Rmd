...
**420-A58-SF - Algorithmes d'apprentissage non supervisé - Été 2020 - Spécialisation technique en Intelligence Artificielle** MIT License - Copyright (c) 2020 Mikaël Swawola
...
autoplot(myts, facets=T) # ou autoplot(myts,facets=TRUE)
```
